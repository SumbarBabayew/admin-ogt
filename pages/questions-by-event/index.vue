...
import { getEvents } from "@/service/admin.api.js";
import QuestionsByEventTable from '@/components/tables/QuestionsByEventTable.vue';
...
<template>
  ...
  <div v-else>
    ...
    />
    <QuestionsByEventTable :items="items" :count="count" />
