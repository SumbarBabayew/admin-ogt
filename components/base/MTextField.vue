  ...
  <div :class="classes" :style="{ width: props.width ? `${props.width}px` : null }">
    ...
    <div class="input__body">
      ...
      <div class="input__input">
        <button class="input__input__button" v-if="props.type === 'button'" @click="$emit('click:input')"
        ...
        <div v-if="props.type === 'number'" class="input_number_box">
          <span class="prefix">{{ props.prefix }}</span>

          <input :style="{ height: props.height ? `${props.height}px` : null }" :type="props.type"
            :placeholder="props.placeholder" :value="props.modelValue || props.value" :disabled="props.disabled"
            :readonly="props.readonly" @click="$emit('click:input')" @input="(event) => update(event.target.value)" />
        </div>

        <input class="input__input__text" v-else :style="{ height: props.height ? `${props.height}px` : null }"
