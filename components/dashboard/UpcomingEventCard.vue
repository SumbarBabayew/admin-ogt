...
import { deleteUpcomingEvent } from "@/service/admin.api";
...
const deleteItem = async (c) => {
  ...
  await deleteUpcomingEvent({ id: c }).then(() => {
        ...
        <div class="d-flex justify-end  mt-n5">
          ...
          <v-menu :close-on-content-click="false">
            ...
            <v-sheet rounded="md" width="200" elevation="10" class="mt-2">
              <v-list class="py-0" lines="one" density="compact" @click="$goPage(`/upcoming-events/features/${card.id}`, {})">
              </v-list>
              <v-list class="py-0" lines="one" density="compact" @click="$goPage(`/upcoming-events/${card.id}`, {})">
