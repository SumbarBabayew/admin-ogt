...
import { deletePartner } from "@/service/admin.api";
...
<template>
  <v-row>
    <v-col cols="12" lg="2" sm="6" v-for="(card, i) in  props.items " :key="i">
      <v-card elevation="10" class="withbg store__card" rounded="md">
        ...
        <div class="d-flex justify-end  mt-n5">
          ...
          <v-menu :close-on-content-click="false">
            ...
            <v-sheet rounded="md" width="200" elevation="10" class="mt-2">
              ...
              <v-list class="py-0" lines="one" density="compact" @click="$goPage(`/partners/${card.id}`, {})">
                <v-list-item value="item2" active-color="primary">
                  <template v-slot:prepend>
        ...
        <v-card-item class="pt-0 d-flex">
          <h6 class="text-h6" v-text="`${card.partnerTypeEn}`"></h6>
