    ...
    <div class="container">
      ...
      <ul class="responsive-table">
        ...
        <li class="table-row" v-for="(item, i) in items">
          ...
          <div class="col col-2" data-label="Title RU">{{item.title}}</div>
          <div class="col col-2" data-label="Title X">{{item.subtitle}}</div>
          <div class="col col-4" data-label="Functions">
            <v-btn size="30" title="Edit" class="profileBtn bg-primary custom-hover-primary" @click="$goPage(`/onboardings/${item.id}`)"
