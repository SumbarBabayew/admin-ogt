    ...
    <div class="container">
      ...
      <ul class="responsive-table">
        <li class="table-header">
          ...
          <div class="col col-2">Website</div>
        ...
        <li class="table-row" v-for="(item, i) in items">
          ...
          <div class="col col-2" data-label="Name">{{item.nameEn}}</div>
          <div class="col col-2" data-label="Website">{{item.siteUrl}}</div>
          <div class="col col-4" data-label="Functions">
            <v-btn size="30" class="profileBtn bg-primary custom-hover-primary" @click="$goPage(`/companies/${item.id}`)"
            ...
            <v-btn size="25" class="profileBtn bg-success custom-hover-primary" variant="text" @click="$goPage(`/companies/speakers/${item.id}`)"
              v-bind="props">
              <UsersIcon size="15" />
            </v-btn>
          </div>
