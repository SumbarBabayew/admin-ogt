      ...
      <ul class="responsive-table">
        ...
        <li class="table-row" v-for="(item, i) in items">
          <div class="col col-2" data-label="Suraty">
            <img crossorigin="anonymous" class="image" :src="baseUrl.url_base + '/' + item.photo" />
          </div>
          ...
          <div class="col col-2" data-label="Organisation">{{item.companyCountry}}</div>
          ...
          <div class="col col-4" data-label="Functions">
            <v-btn size="30" class="profileBtn bg-primary custom-hover-primary" @click="$goPage(`/visa-request/${item.id}`)"
