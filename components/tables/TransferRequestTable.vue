    ...
    <div class="container">
      ...
      <ul class="responsive-table">
        <li class="table-header">
          ...
          <div class="col col-2">Transfer</div>
        ...
        <li class="table-row" v-for="(item, i) in items">
          ...
          <div class="col col-2" data-label="Transfer">{{item.transferFeature.transfer.nameEn || ""}}, {{item.transferFeature.nameEn || ""}}</div>
          ...
          <div class="col col-4" data-label="Functions">
            <v-btn size="30" class="profileBtn bg-primary custom-hover-primary" @click="$goPage(`/transfer-request/${item.id}`)"
