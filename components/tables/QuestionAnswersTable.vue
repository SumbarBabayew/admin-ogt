    ...
    <div class="container">
      ...
      <ul class="responsive-table">
        <li class="table-header">
          <div class="col col-1">Question EN</div>
          <div class="col col-2">Answer EN</div>
          <div class="col col-4">Functions</div>
        </li>
        <li class="table-row" v-for="(item, i) in items">
          <div class="col col-1" data-label="Title EN">{{ item.questionEn }}</div>
          <div class="col col-2" data-label="Title RU">{{item.answerEn}}</div>
          <div class="col col-4" data-label="Functions">
            <v-btn size="30" class="profileBtn bg-primary custom-hover-primary" @click="$goPage(`/questions-answers/${item.id}`)"
