    ...
    <div class="container">
      ...
      <ul class="responsive-table">
        <li class="table-header">
          ...
          <div class="col col-2">Name X</div>
          <div class="col col-4">Functions</div>
        </li>
        <li class="table-row" v-for="(item, i) in items">
          <div class="col col-1" data-label="Name EN">{{ item.nameEn }}</div>
          <div class="col col-2" data-label="Name RU">{{item.nameRu}}</div>
          <div class="col col-2" data-label="Name RU">{{item.nameX}}</div>
          
          <div class="col col-4" data-label="Functions">
            <!-- <v-btn size="30" class="profileBtn bg-primary custom-hover-primary" @click="$goPage(`/users/${item.id}`)"
