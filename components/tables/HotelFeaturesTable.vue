      ...
      <ul class="responsive-table">
        ...
        <li class="table-row" v-for="(item, i) in items">
          <div class="col col-2" data-label="Image">
            <img crossorigin="anonymous" class="image" :src="baseUrl.url_base + '/' + item.icon" />
          </div>
