    ...
    <div class="container">
      ...
      <ul class="responsive-table">
        <li class="table-header">
          ...
          <div class="col col-2">Hotel</div>
          <div class="col col-2">Price</div>
          <div class="col col-4">Functions</div>
        </li>
        <li class="table-row" v-for="(item, i) in items">
          <div class="col col-1" data-label="Title">{{ item.nameEn }}</div>
          <div class="col col-2" data-label="Hotel">{{item.hotel != null ? item.hotel.nameEn : 'No hotel'}}</div>
          <div class="col col-2" data-label="Price">{{item.price}}$</div>
          <div class="col col-4" data-label="Functions">
            <v-btn size="30" class="profileBtn bg-primary custom-hover-primary" @click="$goPage(`/rooms/${item.id}`)"
