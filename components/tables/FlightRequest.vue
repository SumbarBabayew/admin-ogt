    ...
    <div class="container">
      ...
      <ul class="responsive-table">
        <li class="table-header">
          ...
          <div class="col col-2">Nationality</div>
        ...
        <li class="table-row" v-for="(item, i) in items">
          ...
          <div class="col col-2" data-label="Passport" style="color: green">{{item.event!= null ? item.event.name : ""}}</div>
          <div class="col col-2" data-label="Nationality">{{item.nationality}}</div>
          <div class="col col-2" data-label="Start">{{item.flight.start.nameEn }}</div>
          <div class="col col-2" data-label="Destination">{{item.flight.destination.nameEn}}</div>
          
          <div class="col col-4" data-label="Functions">
            <v-btn size="30" class="profileBtn bg-primary custom-hover-primary" @click="$goPage(`/flight-request/${item.id}`)"
